...
#define UI_THEME_COLOR_MAINTHEME 0

#define UI_THEME_DEFAULT 0

#define UI_THEME_ORANGETHEME 1

#define UI_THEME_GREENTHEME 2

extern const ui_theme_variable_t _ui_theme_color_MainTheme[3];
extern const ui_theme_variable_t _ui_theme_alpha_MainTheme[3];
